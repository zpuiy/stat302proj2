...
According the the result the p-value is `r twoSided_gdp$p_val`, which is greater than 0.05, I reject the null hypothesis that the average life expectancy is equal to 60 and accept the alternate hypothesis. Therefore, I conclude that the true mean of life expectancy is not equal to 60.
